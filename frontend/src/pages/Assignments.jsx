      ...
      {assignments.length === 0 ? (
        <div className="bg-white rounded-2xl shadow-xl p-12 text-center border border-gray-100">
          ...
          <p className="mt-2 text-gray-600 max-w-md mx-auto">
            Get started by uploading your first assignment for AI and plagiarism analysis.
          </p>
          <div className="mt-8">
            <button
              onClick={() => setShowUploadModal(true)}
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
          <div className="divide-y divide-gray-100">
            {assignments.map((assignment) => (
              <div key={assignment.id} className="p-6 hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50 transition-all duration-200 group">
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-4 flex-1">
                        ...
                        <p className="text-sm text-gray-600 mt-1 font-medium">
                          <span className="text-[#3282B8]">Student:</span> {assignment.student_name} • 
                          <span className="text-[#3AB795] ml-1">Course:</span> {assignment.course_name}
                        </p>
