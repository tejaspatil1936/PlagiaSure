  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="bg-gradient-primary shadow-lg">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              <img 
                ...
                className="h-10 w-10"
              />
              <span className="text-2xl font-bold text-white">PlagiaSure</span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link 
                to="/signup" 
                className="bg-white text-[#2D4B7C] px-6 py-2 rounded-full font-semibold hover:bg-gray-100 transition-colors"
              >
                Get Started
              </Link>
            </div>
        ...
        {/* Mobile Navigation */}
        {mobileMenuOpen && (
          <div className="md:hidden bg-[#2D4B7C] border-t border-white/20">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <a href="#features" className="block px-3 py-2 text-white hover:bg-white/10 rounded-md">Features</a>
              <a href="#pricing" className="block px-3 py-2 text-white hover:bg-white/10 rounded-md">Pricing</a>
              <a href="#about" className="block px-3 py-2 text-white hover:bg-white/10 rounded-md">About</a>
              <Link to="/login" className="block px-3 py-2 text-white hover:bg-white/10 rounded-md">Login</Link>
              <Link to="/signup" className="block px-3 py-2 text-white hover:bg-white/10 rounded-md">Get Started</Link>
            </div>
          </div>
        )}
      </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <h1 className="text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                Advanced AI & 
                <span className="block text-gradient-secondary">Plagiarism Detection</span>
              </h1>
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Protect academic integrity with our cutting-edge AI technology. 
                Detect plagiarism and AI-generated content with 99%+ accuracy using 
                multiple free APIs and advanced machine learning.
              </p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-2xl">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div className="bg-gradient-secondary h-2 rounded-full" style={{width: '87%'}}></div>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600">Plagiarism Score</span>
                      <span className="text-2xl font-bold text-orange-600">34.7%</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div className="bg-gradient-accent h-2 rounded-full" style={{width: '35%'}}></div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our comprehensive suite of tools helps educators maintain the highest standards 
              of academic integrity with cutting-edge AI technology.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">How PlagiaSure Works</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Trusted by Educators</h2>
            <p className="text-xl text-gray-600">See what educators are saying about PlagiaSure</p>
          </div>
      ...
      <footer className="bg-[#2D4B7C] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                <img src="/plagiasure.png" alt="PlagiaSure Logo" className="h-8 w-8" />
          ...
          <div className="border-t border-white/20 mt-8 pt-8 text-center text-white/60">
            <p>&copy; 2024 PlagiaSure. All rights reserved. Powered by advanced AI and free APIs.</p>
          </div>
        </div>
      </footer>
    </div>
...
const FeatureCard = ({ icon: Icon, title, description, gradient }) => (
  <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
    <div className={`${gradient} w-12 h-12 rounded-lg flex items-center justify-center mb-4`}>
