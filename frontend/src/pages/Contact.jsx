          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="bg-[#3282B8] p-3 rounded-lg">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              {isSubmitted ? (
                <div className="text-center py-12">
                  <CheckCircle className="w-16 h-16 text-[#52DE97] mx-auto mb-4" />
                  ...
                  <button
                    ...
                    className="bg-[#3282B8] text-white px-6 py-3 rounded-lg hover:bg-[#2D4B7C] transition-colors"
                  >
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-[#3282B8] to-[#52DE97] text-white py-4 px-6 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 flex items-center justify-center space-x-2 disabled:opacity-50"
                    >
                      {isSubmitting ? (
                        <span>Sending...</span>
                      ) : (
