...
---
Report generated by PlagiaSure - Advanced AI & Plagiarism Detection
🔗 Visit: https://plagiasure.com
📧 Support: support@plagiasure.com
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4">
      ...
      <div className="mt-3 text-xs text-gray-500">
        ...
        <div className="flex items-center justify-between mt-2 pt-2 border-t border-gray-100">
          <span>Generated by PlagiaSure</span>
          <img src="/plagiasure.png" alt="PlagiaSure" className="h-3 w-3" />
        </div>
      </div>
    </div>
  );
